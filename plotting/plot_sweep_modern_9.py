...
sweep_variables = np.array([10,20,30,40])
xlabel = "Distance from POIs to Leader-Follower Pairs"
...
figname = "Experiment 3 "+xlabel+"_sweep_trials"
if plot_min_max_range:
