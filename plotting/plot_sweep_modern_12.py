...
sweep_variables = np.array([1,2,3])
xlabel = "Number of Followers Per Leader"
...
sweep_stats_G, sweep_stats_D, sweep_stats_Df, sweep_stats_Z = get1DSweepStatistics(
    ...
    last_trial_num = 89, 
    num_stat_runs = 10, 
    computer_name = "coupling_1_5leaders",
    tested_Zero = False,
    tested_Dfollow = True, 
    tested_D = True,
    tested_G = True
...
figname = "Experiment coupling_1_5leaders partial "+xlabel+"_sweep_trials"
if plot_min_max_range:
