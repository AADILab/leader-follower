...
env_kwargs = {"num_leaders": 1, "num_followers": 0, "FPS": 5, "num_steps": 10*5, "render_mode": 'none', "map_size": np.array([100,100]),
    ...
    "spawn_midpoint": np.array([50.,50.]), "spawn_radius": 5,
    "spawn_velocity": 0,
    # "headings": np.array([[-np.pi]]),
    "poi_positions": np.array([[20.,20.],[20.,80.],[80.,20.],[80.,80.]])} # ,[20.,80.],[80.,20.],[80.,80.]
learner = Learner(population_size=15, num_parents=5, sigma_mutation=0.15, nn_inputs=env_kwargs["poi_positions"].size, nn_hidden=[10], nn_outputs=2, init_population = initial_population, env_kwargs=env_kwargs)
