...
if __name__ == '__main__':
    ...
    # Need to only do the cases with 100 leaders, followers, pois
    for i_group in [99]:
	...
	# Actually only need to run 1 for G because configs 309 and 310 already did the first 2 stat runs for G
        for _ in range(1):
