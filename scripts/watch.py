...
# from leader_follower.network_lib import create_nn_from_weights
# from leader_follower.ccea_lib import computeAction
# from leader_follower.file_helper import getLatestTrialName, loadTrial, loadConfig
#
# PLOT_SCORES = True
# PLAY_ENV = True
# TRIAL_NAME = getLatestTrialName()
#
# # Load in the trial data
# save_data = loadTrial(TRIAL_NAME)
...
# config_filename = "config_" + TRIAL_NAME.split('_')[1] + ".yaml"
...
#     networks = [create_nn_from_weights(genome_data.genome) for genome_data in best_team_data.team]
...
#             start_time = time()
#             actions = {agent: computeAction(network, observations[agent], env) for agent, network in
