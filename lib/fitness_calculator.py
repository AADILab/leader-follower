...
class FitnessCalculator():
    def __init__(self, poi_colony: POIColony, boids_colony: BoidsColony, which_G: Union[WhichG, str], which_D: Union[WhichD, str], which_F: Union[WhichF, str], potential_type: Union[PotentialType, str], use_drip: Union[UseDrip, str], follower_switch: Union[FollowerSwitch, str] = FollowerSwitch.UseLeadersAndFollowers) -> None:
    ...
    def calculateDs(self, G: float, position_history: List[np.ndarray]):
        if self.which_D == WhichD.G:
            ...
            # if(self.which_F == WhichF.FCDistance):
            #     pbrs = self.calculate_coupling_potential(self.boids_colony.num_followers_influenced, potential_values, position_history)
            #     #print(pbrs)
            #     pbrs = np.array(pbrs)

            #     difference_follower_evaluations = (np.array(difference_follower_evaluations) + pbrs).tolist()
            #     #print()
            #     #print(difference_follower_evaluations)
            #     #print()
